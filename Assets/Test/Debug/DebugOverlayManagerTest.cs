...
namespace ProjectRise.Test.Debug
{
    ...
    public class DebugOverlayManagerTest
    {
        ...
        public void ContainsMode()
        {
            ...
            _debugOverlayManager.RegisterMode(new DebugMode(id1, "name1", true), new FakeUiFactory());
        ...
        public void GetAllRootUiElements()
        {
            ...
            Assert.That(_debugOverlayManager.GetAllRootUiElements(), Is.EqualTo(uiFactory.GameObjects));
        }
    }
